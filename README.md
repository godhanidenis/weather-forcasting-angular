...
You may choose a task to complete out of two tasks; one is more of day to day one, and the other one is a bit more challenging, but your choice is not going to determine anything, just options to see your strong suit.
...
# The challenging task: a Line Chart
...
-   The app should reflect the chosen currency on the URL, so on the page refresh, we see the chart we picked before.
